! function (t, e) {
    ...
    var a = function (t, e) {
        ...
        f = function () {
            function t(e, i) {
                a(this, t), this.x = l(e), this.y = l(i)
            }
            return u(t, null, [{
                key: "equals",
                value: function (t, e) {
        ...
        c = function () {
            function t(e, i, n, s, o) {
                a(this, t), this.id = o, this.left = e, this.top = i, this.width = n, this.height = s
            }
            return u(t, null, [{
                key: "intersects",
                value: function (t, e) {
        ...
        p = function () {
            function t(e) {
                a(this, t), m += 1, this.id = m, this.element = e, this.isVisible = !0, this.isHidden = !1
            }
            return u(t, [{
                key: "show",
                value: function () {
                ...
                key: "init",
                value: function () {
                    this.addClasses([d.SHUFFLE_ITEM, d.VISIBLE]), this.applyCss(t.Css.INITIAL), this.scale = t.Scale.VISIBLE, this.point = new f
                }
            }, {
                key: "addClasses",
                value: function (t) {
    ...
    y.style.cssText = "width:10px;padding:2px;box-sizing:border-box;", v.appendChild(y);
    var g = "10px" === window.getComputedStyle(y, null).width;

    function _(t, e) {
        var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : window.getComputedStyle(t, null),
            n = l(i[e]);
        return g || "width" !== e ? g || "height" !== e || (n += l(i.paddingTop) + l(i.paddingBottom) + l(i.borderTopWidth) + l(i.borderBottomWidth)) : n += l(i.paddingLeft) + l(i.paddingRight) + l(i.borderLeftWidth) + l(i.borderRightWidth), n
    }
    v.removeChild(y);
    var E = {
        reverse: !1,
    ...
    function k(t) {
        return !!b[t] && (b[t].element.removeEventListener(S, b[t].listener), b[t] = null, !0)
    }

    function w(t, e) {
        var i = S + (T += 1),
            n = function (t) {
                t.currentTarget === t.target && (k(i), e(t))
            };
        return t.addEventListener(S, n), b[i] = {
            element: t,
            listener: n
        }, i
    }
    ...
    function D(t, e, i) {
        if (1 === e) return t;
        for (var n = [], s = 0; s <= i - e; s++) n.push(C(t.slice(s, s + e)));
        return n
    }
        ...
        return Object.keys(i).forEach(function (t) {
            ...
            if (u > 0) {
                ...
                (f = r.every(function (t) {
                    var e = new c(t.left + u, t.top, t.width, t.height, t.id),
                        i = !n.some(function (t) {
                            return c.intersects(e, t)
                        });
                    return d.push(e), i
                })) && (h = d)
            }
    ...
    var F = 0,
        x = function (t) {
            function i(t) {
                ...
                a(this, i);
                var n = h(this, (i.__proto__ || Object.getPrototypeOf(i)).call(this));
                n.options = Object.assign({}, i.options, e), n.options.delimeter && (n.options.delimiter = n.options.delimeter), n.lastSort = {}, n.group = i.ALL_ITEMS, n.lastFilter = i.ALL_ITEMS, n.isEnabled = !0, n.isDestroyed = !1, n.isInitialized = !1, n._transitions = [], n.isTransitioning = !1, n._queue = [];
                var s = n._getElementOption(t);
                if (!s) throw new TypeError("Shuffle needs to be initialized with an element.");
                return n.element = s, n.id = "shuffle_" + F, F += 1, n._init(), n.isInitialized = !0, n
            }
            return function (t, e) {
                ...
                key: "_init",
                value: function () {
                    if (this.items = this._getItems(), this.options.sizer = this._getElementOption(this.options.sizer), this.element.classList.add(i.Classes.BASE), this._initItems(this.items), this._onResize = this._getResizeFunction(), window.addEventListener("resize", this._onResize), "complete" !== document.readyState) {
                    ...
                    this._validateStyles(e), this._setColumns(n), this.filter(this.options.group, this.options.initialSort), this.element.offsetWidth, this.setItemTransitions(this.items), this.element.style.transition = "height " + this.options.speed + "ms " + this.options.easing
                }
            }, {
                ...
                value: function (t, e) {
                    var n = this,
                        s = [],
                        o = [];
                    return t === i.ALL_ITEMS ? s = e : e.forEach(function (e) {
                ...
                value: function (t, e) {
                    ...
                    return Array.isArray(t) ? this.options.filterMode === i.FilterMode.ANY ? t.some(o) : t.every(o) : s.includes(t)
                }
            }, {
                ...
                value: function (t) {
                    var e = this.options,
                        ...
                        o = Object.keys(p.Css.HIDDEN.before).map(function (t) {
                ...
                value: function (t, e) {
                    var n = void 0;
                    return 0 === (n = "function" == typeof this.options.columnWidth ? this.options.columnWidth(t) : this.options.sizer ? i.getSize(this.options.sizer).width : this.options.columnWidth ? this.options.columnWidth : this.items.length > 0 ? i.getSize(this.items[0].element, !0).width : t) && (n = t), n + e
                }
            }, {
                key: "_getGutterSize",
                value: function (t) {
                    return "function" == typeof this.options.gutterWidth ? this.options.gutterWidth(t) : this.options.sizer ? _(this.options.sizer, "marginLeft") : this.options.gutterWidth
                }
            }, {
                key: "_setColumns",
                value: function () {
                ...
                value: function (t) {
                    ...
                    t.forEach(function (t, s) {
                        function o() {
                            t.applyCss(p.Css.VISIBLE.after)
                        }
                        if (f.equals(t.point, i[s]) && !t.isHidden) return t.applyCss(p.Css.VISIBLE.before), void o();
                        t.point = i[s], t.scale = p.Scale.VISIBLE, t.isHidden = !1;
                        var r = e.getStylesForTransition(t, p.Css.VISIBLE.before);
                ...
                value: function (t) {
                    ...
                    if (this.options.isCentered) {
                        var n = t.map(function (t, n) {
                            var s = i.getSize(t.element, !0),
                                o = e._getItemPosition(s);
                            return new c(o.x, o.y, s.width, s.height, n)
                        });
                ...
                value: function (t) {
                    return function (t) {
                        for (var e = t.itemSize, i = t.positions, n = t.gridSize, s = t.total, o = t.threshold, r = t.buffer, l = L(e.width, n, s, o), a = D(i, l, s), u = z(a, r), h = new f(n * u, a[u]), c = a[u] + e.height, d = 0; d < l; d++) i[u + d] = c;
                        return h
                    }({
                        itemSize: t,
                ...
                value: function () {
                    ...
                    (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this._getConcealedItems()).forEach(function (i) {
                        function n() {
                            i.applyCss(p.Css.HIDDEN.after)
                        }
                        if (i.isHidden) return i.applyCss(p.Css.HIDDEN.before), void n();
                        i.scale = p.Scale.HIDDEN, i.isHidden = !0;
                        var s = t.getStylesForTransition(i, p.Css.HIDDEN.before);
                        s.transitionDelay = t._getStaggerAmount(e) + "ms", t._queue.push({
                            item: i,
                            styles: s,
                            callback: n
                        }), e += 1
                ...
                value: function () {
                    ...
                    e && t && this.isInitialized ? this._startTransitions(this._queue) : e ? (this._styleImmediately(this._queue), this._dispatch(i.EventType.LAYOUT)) : this._dispatch(i.EventType.LAYOUT), this._queue.length = 0
                }
            }, {
                ...
                value: function (t) {
                    ...
                    this.isTransitioning = !0,
                        function (t, e, i) {
                            i || ("function" == typeof e ? (i = e, e = null) : i = r);
                            var n = t && t.length;
                            if (!n) return i(null, []);
                            var s = !1,
                                o = new Array(n);
                ...
                key: "_cancelMovement",
                value: function () {
                    this._transitions.forEach(k), this._transitions.length = 0, this.isTransitioning = !1
                }
            }, {
                ...
                value: function () {
                    this._transitions.length = 0, this.isTransitioning = !1, this._dispatch(i.EventType.LAYOUT)
                }
            }, {
                key: "filter",
                value: function (t, e) {
                    this.isEnabled && ((!t || t && 0 === t.length) && (t = i.ALL_ITEMS), this._filter(t), this._shrink(), this._updateItemCount(), this.sort(e))
                }
            }, {
                key: "sort",
                value: function () {
                    ...
                    if (this.isEnabled) {
                        this._resetCols();
                        var e = I(this._getFilteredItems(), t);
                ...
                value: function (t) {
                    ...
                    var n = I(this._mergeNewItems(i), this.lastSort),
                        s = this._filter(this.lastFilter, n),
                        o = function (t) {
                            return i.includes(t)
                        },
                        r = function (t) {
                            t.scale = p.Scale.HIDDEN, t.isHidden = !0, t.applyCss(p.Css.HIDDEN.before), t.applyCss(p.Css.HIDDEN.after)
                        },
                ...
                value: function (t) {
                    ...
                    if (t.length) {
                        ...
                        this._toggleFilterClasses({
                            ...
                            return !s.includes(t)
                        }), this._updateItemCount(), this.once(i.EventType.LAYOUT, function () {
                            e._disposeItems(s), n.forEach(function (t) {
                ...
                value: function () {
                    var t = this;
                    this._disposeItems(this.items), this.isInitialized = !1, this.items = this._getItems(), this._initItems(this.items), this.once(i.EventType.LAYOUT, function () {
                ...
                value: function (t) {
                    var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                        ...
                        n = _(t, "width", i),
                        s = _(t, "height", i);
                    e && (n += _(t, "marginLeft", i) + _(t, "marginRight", i), s += _(t, "marginTop", i) + _(t, "marginBottom", i));
                    return {
                        width: n,
                        height: s
                    }
    ...
    return x.ShuffleItem = p, x.ALL_ITEMS = "all", x.FILTER_ATTRIBUTE_KEY = "groups", x.EventType = {
        LAYOUT: "shuffle:layout",
        REMOVED: "shuffle:removed"
    }, x.Classes = d, x.FilterMode = {
        ANY: "any",
        ALL: "all"
    }, x.options = {
        group: x.ALL_ITEMS,
        ...
        useTransforms: !0,
        filterMode: x.FilterMode.ANY,
        isCentered: !1,
        roundTransforms: !0
    }, x.Point = f, x.Rect = c, x.__sorter = I, x.__getColumnSpan = L, x.__getAvailablePositions = D, x.__getShortColumn = z, x.__getCenteredPositions = M, x
});
